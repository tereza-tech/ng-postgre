...
function validateBinaryVersion(...command) {
  ...
  if (stdout !== "0.15.13") {
    throw new Error(`Expected ${JSON.stringify("0.15.13")} but got ${JSON.stringify(stdout)}`);
  }
}
function isYarn() {
...
function installUsingNPM(pkg, subpath, binPath) {
  ...
  try {
    ...
    child_process.execSync(
      `npm install --loglevel=error --prefer-offline --no-audit --progress=false ${pkg}@${"0.15.13"}`,
